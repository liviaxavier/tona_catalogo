...
export default function ProfessionalPage({data}: DataBindInterface){
    ...
    return professional && <>
    <Search />
    <Grid sm={12} margin={"auto"} container spacing={2} padding={4}>
        <Grid item sm={12} >
        ...
        <Grid item sm={12} md={8}>
            ...
            <br></br>
            <a target="_blank" href={`https://wa.me/55${professional["Contato divulgação"]}`}>Telefone: {professional["Contato divulgação"]}</a>
        </Grid>
        <Grid item sm={12}>
            <h3>Descrição</h3>
